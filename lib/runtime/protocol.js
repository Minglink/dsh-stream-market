 ...
 */
export function parseDshProtocolUrl(rawUrl) {
 ...
 * 构造标准 dsh:// 一键安装协议 URL
 */
export function buildDshProtocolUrl(params) {
 ...
 */
export function generateHtmlBadge(params) {
 ...
 */
export function generateMarkdownBadge(params) {
    const url = buildDshProtocolUrl(params);
 ...
 * 根据协议参数执行一键安装流程
 */
export function executeProtocolInstall(params, profile = 'web') {
    // 确定实际拉取源：
